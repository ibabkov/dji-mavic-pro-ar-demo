...
import { ITiltOnMoveOptions, lookAtObject, tiltOnMove } from '@/helpers';
import { useFrame } from '@/hooks/useFrame';

/** Orients the drone each frame: yaw toward `target`, then tilt into motion using that same-frame yaw. */
export const useDroneOrientation = (
	droneRef: RefObject<Object3D | null>,
	target: Object3D,
	tiltOpts: ITiltOnMoveOptions = {},
): void => {
